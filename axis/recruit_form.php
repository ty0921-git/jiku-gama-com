        ...
        <section class="container-fluid">
            ...
            <form action="db_op.php" method="POST" enctype="multipart/form-data">
                ...
                <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="image-tab" data-bs-toggle="tab" href="#image" role="tab" aria-controls="image" aria-selected="false">リクルート画像</a>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-pane fade show active" id="base" role="tabpanel" aria-labelledby="base-tab">
                        <div class="row">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="rec_title" id="rec_title" placeholder="#" value="<?= h($row['rec_title']) ?>">
                                            <label for="rec_title">募集タイトル</label>
                                        </div>
                                ...
                                <div class="row row-cols-md-2 g-3 mb-3">
                                    ...
                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_status" id="rec_status" placeholder="#" style="height:100px;"><?= h($row['rec_status']) ?></textarea>
                                            <label for="rec_status">雇用形態</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_occupation" id="rec_occupation" placeholder="#" style="height:100px;"><?= h($row['rec_occupation']) ?></textarea>
                                            <label for="rec_occupation">職種</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_job_description" id="rec_job_description" placeholder="#" style="height:100px;"><?= h($row['rec_job_description']) ?></textarea>
                                            <label for="rec_job_description">職務内容</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_qualification" id="rec_qualification" placeholder="#" style="height:100px;"><?= h($row['rec_qualification']) ?></textarea>
                                            <label for="rec_qualification">応募資格</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_salary" id="rec_salary" placeholder="#" style="height:100px;"><?= h($row['rec_salary']) ?></textarea>
                                            <label for="rec_salary">給与</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_salary_revision" id="rec_salary_revision" placeholder="#" style="height:100px;"><?= h($row['rec_salary_revision']) ?></textarea>
                                            <label for="rec_salary_revision">給与改定</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_bonus" id="rec_bonus" placeholder="#" style="height:100px;"><?= h($row['rec_bonus']) ?></textarea>
                                            <label for="rec_bonus">賞与</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_holiday" id="rec_holiday" placeholder="#" style="height:100px;"><?= h($row['rec_holiday']) ?></textarea>
                                            <label for="rec_holiday">休暇・休日</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_treatment" id="rec_treatment" placeholder="#" style="height:100px;"><?= h($row['rec_treatment']) ?></textarea>
                                            <label for="rec_treatment">待遇・諸手当</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_welfare" id="rec_welfare" placeholder="#" style="height:100px;"><?= h($row['rec_welfare']) ?></textarea>
                                            <label for="rec_welfare">福利厚生</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_training" id="rec_training" placeholder="#" style="height:100px;"><?= h($row['rec_training']) ?></textarea>
                                            <label for="rec_training">研修制度</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_commendation" id="rec_commendation" placeholder="#" style="height:100px;"><?= h($row['rec_commendation']) ?></textarea>
                                            <label for="rec_commendation">表彰制度</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_time" id="rec_place" placeholder="#" style="height:100px;"><?= h($row['rec_place']) ?></textarea>
                                            <label for="rec_place">勤務地</label>
                                        </div>
                                    </div>

                                    <div class="col">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="rec_time" id="rec_time" placeholder="#" style="height:100px;"><?= h($row['rec_time']) ?></textarea>
                                            <label for="rec_time">勤務時間</label>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control datepicker" name="date_end" id="date_end" placeholder="#" value="<?= h($row['date_end']) ?>">
                                    <label for="date_end">掲載終了日</label>
                                </div>
        ...
        <?php if ($code) : ?>
            <section class="container-fluid mt-5">
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <a href="<?= $table ?>_list.php" class="btn btn-btn">リクルート一覧</a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="alert alert-danger">削除対象 : <?= h($row['rec_title']) ?></div>
                            </div>
